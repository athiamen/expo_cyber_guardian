...
import { lightColors, type AppThemeColors } from "./palette";

export type AppTypography = ReturnType<typeof buildTypography>;

export function buildTypography(colors: AppThemeColors) {
